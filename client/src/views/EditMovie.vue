<template>
  <div class="edit-container">
    <div class="headers" :key="(movieId = $route.params.id)">
      <h1>Edit or delete a movie!</h1>
    </div>
    <form>
      <div class="row">
        <div class="label-col">
      ...
      <div class="submit">
        <button id="button" class="btn btn-primary mr-1" v-on:click="putMovie">
          Edit
        </button>
      </div>
    </form>
...
export default {
  ...
  methods: {
    putMovie() {
      Api.put('/movies/' + this.movieId, this.edits)
    },
    deleteMovie() {
      Api.delete('/movies/' + this.movieId)
    }
  },
  data() {
    return {
